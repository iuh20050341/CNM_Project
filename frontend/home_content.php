    ...
    <div class="row">
        <div class="col-md-12">
            <div class="banner text-center mx-auto">
                <!-- Thêm lớp "text-center" để căn giữa -->
                <!-- Thay đổi đường dẫn và alt theo hình ảnh của banner bạn muốn sử dụng -->
                <div>
                    <a href="#"><img src="./img/banner/banner9.png" alt="Your Banner"
                            style="max-width: 75%; height: auto; display: inline-block; border-radius: 20px; box-shadow: 0 14px 16px rgba(0, 0, 0, 0.1);"
                            class="img-fluid"></a> <!-- Thêm thuộc tính "display: inline-block;" -->
                </div>
            </div>
        </div>
    </div>
    ...
    <div class="container">
        ...
        <div class="row">
            ...
            <div class="col-md-4 col-xs-6">
                <div class="shop" style="width: 350pxl;">
                    <div class="shop-img">
                        <img src="https://vietjack.me/storage/uploads/images/34622/gia-dinh-hanh-phuc-hoat-hinh-10-1697616192.jpg"
                            alt="">
                    </div>
                    <div class="shop-body">
                        <a href="#">
            ...
            <div class="col-md-4 col-xs-6">
                <div class="shop" style="width: 350pxl;">
                    <div class="shop-img">
                        <img src="https://cdnmedia.baotintuc.vn/Upload/pTMF1jgWpbjY1m8G1xWUsg/files/2022/12/dongnai.jpg"
                            alt="">
                    </div>
                    <div class="shop-body">
                        <a href="#">
