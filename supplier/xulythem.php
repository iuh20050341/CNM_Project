...
<body>
                                            ...
                                            if ($_POST['content'] != '') {
                                                ...
                                                if ($_FILES['image']['name'] != NULL) {
                                                    ...
                                                    if ($_FILES['image']['type'] == "image/jpeg" || $_FILES['image']['type'] == "image/png" || $_FILES['image']['type'] == "image/gif") {
                                                        ...
                                                        VALUES ('$namei','$image_url', " . str_replace('.', '', $price) . ", '$content','$sl','$idtl','$ncc',0,'$idnb');";
    ...
    if (isset($_POST['btntladd'])) {
        if (isset($_POST['name']))
            if ($_POST['name'] != '') {
                ...
                else header("location:./supplier.php?act=addtltc&dk=no");
            } else header("location:./supplier.php?act=addtltc&dk=no");
    }
    if (isset($_POST['btntlsua'])) {
        if (isset($_POST['name']))
            if ($_POST['name'] != '') {
                ...
                else header("location:./supplier.php?act=suatltc&dk=no");
            } else header("location:./supplier.php?act=suatltc&dk=no");
    }
                        ...
                        if (isset($_POST['website']))
                            if ($_POST['website'] != '') {
                                if (isset($_POST['sdt']))
                                    ...
                                    } else header("location:./supplier.php?act=nccaddtc&dk=no");
                            } else header("location:./supplier.php?act=nccaddtc&dk=no");
                    } else header("location:./supplier.php?act=nccaddtc&dk=no");
            } else header("location:./supplier.php?act=nccaddtc&dk=no");
    }
    ...
    if (isset($_POST['btntkmk'])) {
        if (isset($_POST['matkhaumoi']))
            if ($_POST['matkhaumoi'] != '') {
                ...
                else header("location:./supplier.php?act=tkmktc&dk=no");
            } else header("location:./supplier.php?act=tkmktc&dk=no");
    }
                    ...
                    if ($_POST['matkhau'] != '') {
                        if (isset($_POST['name']))
                            if ($_POST['name'] != '') {
                                ...
                                else header("location:./supplier.php?act=addtktc&dk=no");
                            } else header("location:./supplier.php?act=addtktc&dk=no");
                    } else header("location:./supplier.php?act=addtktc&dk=no");
            } else header("location:./supplier.php?act=addtktc&dk=no");
    }
    ...
    if (isset($_POST['btndmadd'])) {
        ...
        $inserted = mysqli_query($con, "INSERT INTO `quyendahmuc`(`id_quyen`, `id_danhmuc`) VALUES " . $inserts . "");
        if($inserted) header("location:./supplier.php?act=btndmaddtc&dk=yes");
        else header("location:./supplier.php?act=btndmaddtc&dk=no");
        }else header("location:./supplier.php?act=btndmaddtc&dk=no");
    ...
    if (isset($_POST['btndmsua'])) {
        ...
        $inserted = mysqli_query($con, "INSERT INTO `quyendahmuc`(`id_quyen`, `id_danhmuc`) VALUES " . $inserts . "");
        var_dump($inserted);
        if($inserted) header("location:./supplier.php?act=btndmsuatc&dk=yes");
