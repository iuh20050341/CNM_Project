...
<body>
    ...
    if (isset($_SESSION['ten_dangnhap']) && !empty($_SESSION['ten_dangnhap']) && $_SESSION['user_id']) {
        ...
        if (isset($_POST['search'])) {
            $sql = "SELECT * FROM `sanpham` WHERE id_nhaban = $user_id AND trangthai IN (4, 6)";
            ...
            $totalRecordsQuery = "SELECT * FROM `sanpham` WHERE id_nhaban = $user_id AND trangthai IN (4, 6)";
        ...
        if (isset($_POST['search'])) {
            ...
            $query = "SELECT * FROM `sanpham` WHERE id_nhaban = $user_id AND trangthai IN (4, 6) LIMIT $item_per_page OFFSET $offset";
            ...
            <div class="form-row">
                ...
                <div class="form-group col-md-3">
                    ...
                    <select id="status" name="status" class="form-control">
                        ...
                        <option value="6">Đang chờ duyệt</option>
                        ...
                        <tr>
                            ...
                            <td style="text-align:center; padding-top: 50px">
                                <form method="POST" action="xulythem.php">
                                    ...
                                    <button type="submit" name="btndang"
                                        onclick="return confirm('Bạn có muốn gửi yêu cầu đăng sản phẩm?')">Đăng</button>
                                </form>
