...
<div class="main-content">
    ...
    <div class="product-items">
        <div class="buttons">
            <a style="cursor: pointer" href="admin.php?act=addquyen">Thêm Quyền</a>
        </div>
            ...
            <table class="table table-bordered table-striped table-hover">
                ...
                <tbody>
                    ...
                    <tr>
                        ...
                        <td><a style="cursor: pointer" href="admin.php?act=xoaquyen&id=<?= $row['id'] ?>"
                                onclick="return confirm('Bạn có muốn xóa quyền?');">Xóa</a></td>
