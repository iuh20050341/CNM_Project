        ...
        <div class="wrap-field">
            ...
            <select disabled name="idtl">
                <option value="<?= $product['id_the_loai'] ?>">ID hiện tại: <?= $product['id_the_loai'] ?> -
                    <?= $product['ten_tl'] ?>
                </option><?php while ($row = mysqli_fetch_array($theloai)) { ?>
            ...
            <div class="wrap-field">
                ...
                <div class="qr-content-modal" id="qr-modal">
                    <div class="modal-content">
                        ...
                        <div class="qr-field">
                            <label>Xuất xứ:</label>
                            <input readonly type="text" name="xuatsu"
                                value="<?= (!empty($product) ? $product['xuatsu'] : "") ?>" />
                    </div>
                    <div class="qr-field">
                        <label>Phân bón:</label>
                        <input readonly type="text" name="phanbon"
                            value="<?= (!empty($product) ? $product['phanbon'] : "") ?>" />
                    </div>
                    <div class="qr-field">
                        <label>Chất lượng:</label>
                        <input readonly type="text" name="chatluong"
                            value="<?= (!empty($product) ? $product['chatluong'] : "") ?>" />
                    </div>
                    <div class="qr-field">
                        <label>Chất lượng:</label>
                        <input readonly type="text" name="dotuoi"
                            value="<?= (!empty($product) ? $product['dotuoi'] : "") ?>" />
                    </div>
                    <div class="qr-field">
                        <label>Chất lượng:</label>
                        <input readonly type="text" name="antoanthucpham"
                            value="<?= (!empty($product) ? $product['antoanthucpham'] : "") ?>" />
                    </div>
                    <div class="qr-field">
                        <label>Chất lượng:</label>
                        <input readonly type="text" name="tinhhopphapnguongoc"
                            value="<?= (!empty($product) ? $product['tinhhopphapnguongoc'] : "") ?>" />
                    </div>
                    <div class="qr-field">
                        <label>Bảo quản:</label>
                        <input readonly type="text" name="dieukienbaoquan"
                            value="<?= (!empty($product) ? $product['dieukienbaoquan'] : "") ?>" />
                    </div>
                    <div class="qr-field">
                        <label>Vận chuyển:</label>
                        <input readonly type="text" name="phantichvisinhvat"
                            value="<?= (!empty($product) ? $product['phantichvisinhvat'] : "") ?>" />
                    </div>
                </div>
            </div>
            <div class="clear-both"></div>
